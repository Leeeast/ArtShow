...
public abstract class ConfirmPopup<V extends View> extends BasicPopup<View> {
    ...
    protected int topLineColor = 0xFFCDCDCD;
    ...
    protected int cancelTextColor = 0xFF666666;
    protected int submitTextColor = 0xFF007AFF;
    protected int submitTextColor_P = 0xFF0000FF;
    protected int titleTextColor = Color.BLACK;
    protected int pressedTextColor = 0XFF333333;
    protected int cancelTextSize = 15;
    protected int submitTextSize = 15;
    ...
    protected View makeHeaderView() {
        ...
        submitButton.setTextColor(ConvertUtils.toColorStateList(submitTextColor, submitTextColor_P));
        if (submitTextSize != 0) {
