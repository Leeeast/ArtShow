...
public class ProjectShowIntroFragment extends BaseFragment {
    ...
    public static class MyHandler extends Handler {
        ...
        private WeakReference<ProjectShowIntroFragment> reference;

        public MyHandler(ProjectShowIntroFragment fragment) {
        ...
        public void handleMessage(Message msg) {
            ...
            ProjectShowIntroFragment fragment = reference.get();
            if (fragment == null) return;
            switch (msg.what) {
                case CODE_COMMIT:
                    String richText = (String) msg.obj;
                    fragment.changeShowDescription(richText);
                    break;
            }
        }
    }
    ...
    public void initData(@Nullable Bundle bundle) {
        ...
        urlH5 = String.format(
                Constant.URL_REPERTORY_PLOT_WYSIWYG,
                id,
     ...
     * 修改简历个人介绍
     */
    public void changeShowDescription(final String showDes) {
        //判断是否登录
            ...
            public void onSuccess(boolean isSuccess, String obj, int code, int id) {
                ...
                if (isSuccess) {
                    try {
                        ...
                        ProjectDetailInfo.getInstance().setPlot(showDes);
