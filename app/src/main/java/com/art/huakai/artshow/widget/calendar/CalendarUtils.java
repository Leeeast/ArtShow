...
public class CalendarUtils {
	...
	public  static String TAG="CalendarUtils";
	...
	public static ArrayList<Day> getDaysOfMonth(Calendar calendar, int passDays, String orderDay) {
		...
		Log.e(TAG, "getDaysOfMonth: orderDay11111=="+orderDay);
		boolean isOrdered = false;
		if (orderDay != null)
			orderInfo = orderDay.split("#");
		Log.e(TAG, "getDaysOfMonth: orderInfo11111=="+orderInfo);
		Calendar month = (Calendar) calendar.clone();
		final int FIRST_DAY_OF_WEEK = 0; // Sunday = 0, Monday = 1
		month.set(Calendar.DAY_OF_MONTH, 1);
		int lastDay = month.getActualMaximum(Calendar.DAY_OF_MONTH);
		...
		Log.e(TAG, "getDaysOfMonth: lastDay="+lastDay+"--firstDay=="+firstDay );
		...
		Log.e(TAG, "getDaysOfMonth: size=="+size );
