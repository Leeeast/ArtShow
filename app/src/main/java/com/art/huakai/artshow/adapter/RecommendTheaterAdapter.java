 ...
 */
public class RecommendTheaterAdapter extends  RecyclerView.Adapter{
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            View view = LayoutInflater.from(mContext).inflate(R.layout.type_four_one_item, parent, false);
...
//            typeOneViewHolder.chinaShowImageView.setImageResource(R.mipmap.test);
            if(list.get(position)!=null){
                if(!TextUtils.isEmpty(list.get(position).getLogo())){
                    ...
                    typeOneViewHolder.chinaShowImageView.setSpecificSizeImageUrl(list.get(position).getLogo(),mContext.getResources().getDimensionPixelSize(R.dimen.DIMEN_132PX)/2,mContext.getResources().getDimensionPixelSize(R.dimen.DIMEN_93PX)/2);
                }
