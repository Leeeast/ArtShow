...
public class ProjectAwardFragment extends BaseFragment {
    ...
    public void initData(@Nullable Bundle bundle) {
        ...
        mDescription = ProjectDetailInfo.getInstance().getAwardsDescpt();
    }
    ...
    public void changeResumeDescription() {
        ...
        params.put("awardsDescpt", mDescription);
            ...
            public void onSuccess(boolean isSuccess, String obj, int code, int id) {
                ...
                if (isSuccess) {
                    try {
                        ...
                        ProjectDetailInfo.getInstance().setAwardsDescpt(mDescription);
