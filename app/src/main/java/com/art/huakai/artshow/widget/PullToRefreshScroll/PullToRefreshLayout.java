package com.art.huakai.artshow.widget.PullToRefreshScroll;
...
//                                    .setBackgroundResource(R.mipmap.refresh_failed);
                ...
                {
                    // 刷新结果停留1秒
                    new RemainHandler(PullToRefreshLayout.this).sendEmptyMessageDelayed(0, 100);
                } else
                {
                    changeState(DONE);
                    hide();
...
//                    loadStateImageView
//                            .setBackgroundResource(R.mipmap.load_succeed);
                }
                break;
            case FAIL:
            default:
...
//                            .setBackgroundResource(R.mipmap.load_failed);
        ...
        {
            // 刷新结果停留1秒
            new RemainHandler(this).sendEmptyMessageDelayed(0, 100);
        } else
        {
            changeState(DONE);
            hide();
...
//                break;
//            case MotionEvent.ACTION_MOVE:
//                if(Math.abs(ev.getRawX()-downX)>Math.abs(ev.getRawY()-downY)||Math.abs(ev.getRawY()-downY)<getResources().getDimensionPixelSize(R.dimen.DIMEN_100PX)){
//                     return false;
//                }
//              break;
//        }
