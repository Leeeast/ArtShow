...
public class TheatreDetailIntroFragment extends BaseFragment {
    ...
    public static TheatreDetailIntroFragment newInstance() {
        TheatreDetailIntroFragment fragment = new TheatreDetailIntroFragment();
        return fragment;
    }
    ...
    public void initData(@Nullable Bundle bundle) {
        ...
        urlH5 = String.format(
                Constant.URL_THEATER_DETAILEDINTRODUCE_WYSIWYG,
                id,
    ...
    public int getLayoutID() {
        return R.layout.fragment_theatre_detail_intro;
    }
    ...
    public void initView(View rootView) {
        ...
        tvTitle.setText(R.string.theatre_detail_intro);
