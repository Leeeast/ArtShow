...
public class TalentDetailFragmentAdapter extends FragmentPagerAdapter {
    private List<HeaderViewPagerFragment> mFragments;
    private String[] mTabArray;

    public TalentDetailFragmentAdapter(FragmentManager fm, List<HeaderViewPagerFragment> fragments, String[] tabArray) {
        super(fm);
        this.mFragments = fragments;
        this.mTabArray = tabArray;
    }

    public TalentDetailFragmentAdapter(FragmentManager fm) {
        super(fm);
    }
