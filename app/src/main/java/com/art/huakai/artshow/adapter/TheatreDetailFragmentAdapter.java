...
public class TheatreDetailFragmentAdapter extends FragmentPagerAdapter {
    private List<HeaderViewPagerFragment> mFragments;
    private String[] mTabArray;

    public TheatreDetailFragmentAdapter(FragmentManager fm, List<HeaderViewPagerFragment> fragments, String[] tabArray) {
        super(fm);
        this.mFragments = fragments;
        this.mTabArray = tabArray;
    }

    public TheatreDetailFragmentAdapter(FragmentManager fm) {
        super(fm);
    }
