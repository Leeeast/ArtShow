...
public class ResumeWorksFragment extends BaseFragment {
    ...
    public static class MyHandler extends Handler {
        ...
        private WeakReference<ResumeWorksFragment> reference;

        public MyHandler(ResumeWorksFragment fragment) {
        ...
        public void handleMessage(Message msg) {
            ...
            ResumeWorksFragment fragment = reference.get();
            if (fragment == null) return;
            switch (msg.what) {
                case CODE_COMMIT:
                    String richText = (String) msg.obj;
                    fragment.changeTalentWorks(richText);
                    break;
            }
        }
    }
    ...
    public void initData(@Nullable Bundle bundle) {
        ...
        urlH5 = String.format(
                Constant.URL_TALENT_WORKSDESCPT_WYSIWYG,
                id,
     ...
     * 修改项目介绍
     */
    public void changeTalentWorks(final String talentDescpt) {
        //判断是否登录
        ...
        if (TextUtils.isEmpty(talentDescpt)) {
        ...
        params.put("userId", LocalUserInfo.getInstance().getId());
        params.put("accessToken", LocalUserInfo.getInstance().getAccessToken());
        params.put("worksDescpt", talentDescpt);
        String sign = SignUtil.getSign(params);
            ...
            public void onSuccess(boolean isSuccess, String obj, int code, int id) {
                ...
                if (isSuccess) {
                    try {
                        ...
                        TalentDetailInfo.getInstance().setWorksDescpt(talentDescpt);
