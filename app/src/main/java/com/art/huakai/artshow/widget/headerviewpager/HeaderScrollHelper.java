package com.art.huakai.artshow.widget.headerviewpager;
        ...
        if (recyclerView != null) {
            ...
            if (layoutManager instanceof LinearLayoutManager) {
                ...
                if (gridLayoutManager.getOrientation()== GridLayoutManager.VERTICAL) {
                    if (firstVisibleItemPosition <= totalSpanCount) {
                        return true;
                    }
                } else {
                    if (firstVisibleItemPosition % totalSpanCount == 1) {
                        return true;
                    }
                }
            }else if(layoutManager instanceof StaggeredGridLayoutManager){
                StaggeredGridLayoutManager staggeredGridLayoutManager= (StaggeredGridLayoutManager) layoutManager;
                int []a = staggeredGridLayoutManager.findFirstCompletelyVisibleItemPositions(null);
                if(a[0]==0){
                    return true;
                }
            }
